...
This supplementary package contains original software, original experiment
artifacts, and third-party datasets. Their licenses are intentionally separate.
...
The synthetic-game CSV files, generated weak-field values under `dataset/csv/`,
and experiment outputs under `result/` are released by the DTG-Shapley authors
...
The public-dataset CSV files under `dataset/csv/` are CSV representations of
third-party works from the UCI Machine Learning Repository. They remain under
CC BY 4.0 and are not covered by the MIT code license.

| Dataset | DOI | UCI record |
| --- | --- | --- |
| Iris | 10.24432/C56C76 | https://archive.ics.uci.edu/dataset/53/iris |
| Wine | 10.24432/C5PC7J | https://archive.ics.uci.edu/dataset/109/wine |
